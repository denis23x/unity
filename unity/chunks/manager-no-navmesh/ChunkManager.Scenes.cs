// Assets/Editor/ChunkManagerNoNavmesh/ChunkManager.Scenes.cs
//
...
// by Unload/Remove here and by the Tag/Layer pipeline in ChunkManager.TagsLayers.cs.
...
namespace ProjectName.EditorTools
{
    public partial class ChunkManagerNoNavmesh
    {
        public static void DeleteChunks(string destFolder, string sceneNamePrefix)
        {
            ...
            Debug.Log($"[ChunkManagerNoNavmesh] Deleted {deleted}/{files.Count} chunk scenes from {destFolder}.");
        }
        ...
        public static void OpenChunksAdditive(string destFolder, string sceneNamePrefix)
        {
            ...
            Debug.Log($"[ChunkManagerNoNavmesh] Opened {opened}/{files.Count} chunk scenes additively from {destFolder}.");
        }
        ...
        public static void LoadChunkScenes(string sceneNamePrefix)
        {
            ...
            if (targets.Count == 0)
            {
                Debug.Log($"[ChunkManagerNoNavmesh] No unloaded chunk scenes with prefix '{sceneNamePrefix}'.");
                return;
            }
            ...
            Debug.Log($"[ChunkManagerNoNavmesh] Loaded {loaded}/{targets.Count} chunk scenes (prefix '{sceneNamePrefix}').");
        }
        ...
        public static void UnloadChunkScenes(string sceneNamePrefix)
        {
            ...
            if (targets.Count == 0)
            {
                Debug.Log($"[ChunkManagerNoNavmesh] No loaded chunk scenes with prefix '{sceneNamePrefix}'.");
                return;
            }
            ...
            Debug.Log($"[ChunkManagerNoNavmesh] Unloaded {unloaded}/{targets.Count} chunk scenes (prefix '{sceneNamePrefix}').");
        }
        ...
        public static void RemoveChunkScenes(string sceneNamePrefix)
        {
            ...
            if (targets.Count == 0)
            {
                Debug.Log($"[ChunkManagerNoNavmesh] No chunk scenes with prefix '{sceneNamePrefix}'.");
                return;
            }
            ...
            Debug.Log($"[ChunkManagerNoNavmesh] Removed {removed}/{targets.Count} chunk scenes (prefix '{sceneNamePrefix}').");
        }
