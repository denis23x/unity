// Assets/Editor/ChunkManagerNoNavmesh/ChunkManager.Addressables.cs
//
...
namespace ProjectName.EditorTools
{
    public partial class ChunkManagerNoNavmesh
    {
        public static void CreateAddressables(string destFolder, string sceneNamePrefix, string groupName, bool simplifyNames)
        {
            ...
            if (settings == null)
            {
                Debug.LogWarning("[ChunkManagerNoNavmesh] Skipped Addressables registration: " +
            ...
            Debug.Log($"[ChunkManagerNoNavmesh] Addressables: registered {registered} scenes in group '{groupName}'" +
        ...
        public static void OpenAddressableGroupsWindow()
        {
            ...
            {
                Debug.LogWarning("[ChunkManagerNoNavmesh] Could not open Addressables Groups window: " +
        ...
        public static void DeleteAddressables(string groupName)
        {
            ...
            if (settings == null)
            {
                Debug.LogWarning("[ChunkManagerNoNavmesh] Skipped Addressables delete: AddressableAssetSettings is null.");
                return;
            }
            ...
            Debug.Log($"[ChunkManagerNoNavmesh] Addressables: removed group '{groupName}' ({entryCount} entries).");
        }
    }
}
